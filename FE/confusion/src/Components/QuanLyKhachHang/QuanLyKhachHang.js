...
import { LogoutOutlined, UserAddOutlined, HomeOutlined } from '@ant-design/icons';
    ...
    return (
        <div className="QuanLyKhachHang">
            <div className="Top">
                ...
                <Link to="/HomeAdmin"> {/* Đường dẫn đến trang home */}
                    <HomeOutlined className="HomeOutlined" />
                </Link>
            </div>
            <div className="AdminHeader">
                ...
                <div className="AdminTable">
                    <ul className="AdminTableList">
                        <li className="qlkh"><Link to="/QuanLyKhachHang">Quản lý khách hàng</Link>
            ...
            <div className="AdminCreateAccount">
             <p>Tạo tài khoản</p>
            <UserAddOutlined className="AdminCreateAccountLogo" />
            </div>
            <div className="AdminContent1">
                Danh sách người dùng
            </div>
            <div className="Adminqlkh">
                <table className="TableAdminqlkh">
                    <thead>
                        <tr>
                            <th>ID khách hàng</th>
